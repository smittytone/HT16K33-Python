...
class HT16K33MatrixGen(HT16K33):
    """
    Micro/Circuit Python class for a standalone HT16K33 
    wired to one or two generic 8x8 matrix LEDs
    ...
    def __init__(self, i2c, i2c_address=0x70):
        ...
        self.def_chars = {}
        super(HT16K33MatrixGen, self).__init__(i2c, i2c_address)
