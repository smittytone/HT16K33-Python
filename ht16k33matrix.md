...
To record a user-definable character, write its pixel pattern (see [set_icon()](#set-iconglyph-col)) and specify the ID you will use to write the character to the display buffer (using [set_character()](#set-characterglyph-icon)).
