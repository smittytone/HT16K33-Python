...
| [Small 4-digit, 14-segment LED](./docs/ht16k33quad.md) | [SparkFun Qwiic Alphanumeric Display](https://www.sparkfun.com/products/16916) |
...
- 3.1.0 *Unreleased*
    - Add `ht16k33quad.py` to support the [SparkFun Qwiic Alphanumeric Display](https://www.sparkfun.com/products/16916).
